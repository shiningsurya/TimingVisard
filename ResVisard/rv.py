"""
Modifying the code to suite my needs
~ Surya
----------------------------------------------------------
...
class VisRes(wx.Frame):
    ...
    """
    title = 'Visualise Residuals on the fly'
    ...
    def create_main_panel(self):
        ...
        self.drawbutton = wx.Button(self.panel, -1, "FIT")
    ...
    def on_about(self, event):
        ...
        *Repeat
        ...
        ---------------------------------------------
        The original motivation to understand how wrong parameters affect the residuals and in which way. 
        Fruit of discussions with Prakash Aragamuswamy and Suryarao Bethapudi. 
